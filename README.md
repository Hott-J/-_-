...
![소프트웨어 품질 속성](https://user-images.githubusercontent.com/47052106/87777625-caa02880-c864-11ea-8766-9d719ebdb7c1.png)
<br/>

> ### 소프트웨어 아키텍처의 설계 과정
![아키텍쳐 설계 과정](https://user-images.githubusercontent.com/47052106/87777693-e4da0680-c864-11ea-8226-51a3b7b0b312.png)
<br/>
...
- 특정 계층만을 교체해 시스템을 개선하는 것이 가능
   ...
   ![레이어 패턴](https://user-images.githubusercontent.com/47052106/87777737-fd4a2100-c864-11ea-9af6-af01ea131d48.png)
   <br/>
...
- 요청을 위하여 동기화되는 경우를 제외하고는 서로 독립적임
   ...
   ![클라이언트서버 패턴](https://user-images.githubusercontent.com/47052106/87777814-1f43a380-c865-11ea-8ee9-2027b9fe0478.png)
   <br/>
...
- 데이터 변환, 버퍼링, 동기화 등에 사용
   ...
   ![파이프필터패턴](https://user-images.githubusercontent.com/47052106/87777947-62057b80-c865-11ea-9d05-b78d4440ea2b.png)
   <br/
...
- 여러 개의 뷰를 만들 수 있어 한 개의 모델에 여러 개의 뷰를 필요로 하는 대화형 애플리케이션에 적합
   ...
   ![모델뷰컨트롤러](https://user-images.githubusercontent.com/47052106/87777996-73e71e80-c865-11ea-9cff-70bb0c5b0af8.png)
   <br/>
...
- 결합도가 강하면 시스템 구현 및 유지보수 작업이 어려움
   ...
   ![결합도](https://user-images.githubusercontent.com/47052106/87778398-1dc6ab00-c866-11ea-9cfc-b2091cb3ed9a.png)
   <br/>
...
- 응집도와 품질은 비례 관계
   ...
   ![응집도](https://user-images.githubusercontent.com/47052106/87778459-3636c580-c866-11ea-982d-b6f0e38656b2.png)
   <br/>
   + 응집도 마지막 우연적 응집도 추가
   <br/>
...
- 팬 아웃 : 호출되는 모듈의 수
   ...
   ![팬인아웃](https://user-images.githubusercontent.com/47052106/87778550-56ff1b00-c866-11ea-89da-298086871e9c.png)
...
![인터페이스 요구사항 분석 절차](https://user-images.githubusercontent.com/47052106/87781259-56b54e80-c86b-11ea-8bd6-fbec2671573c.png)
 <br/>
...
> ### 인터페이스 요구사항 검토 계획 수립
![계획수립](https://user-images.githubusercontent.com/47052106/87781335-79dffe00-c86b-11ea-8c86-02d193419aa2.png)
<br/>
...
- 내외부 시스템이 연계하여 작동할 때 인터페이스별 송수신 방법, 손수신 데이터, 오류 식별 및 처리 방안에 대한 내용을 문서화해놓은 것
...
- 표준화된 인터페이스를 제공하여 시스템 간의 데이터 교환에 일관성을 보장
   ...
   ![미들웨어개념종류](https://user-images.githubusercontent.com/47052106/87781656-0d193380-c86c-11ea-8b0b-91fdf44187d1.png)
   <br/>
